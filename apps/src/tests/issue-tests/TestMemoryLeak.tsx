    ...
    <View style={{ flex: 1, backgroundColor: params.backgroundColor ?? 'red' }}>
      <ScrollView>
        {[...Array(100).keys()].map(index => {
          return <Text key={index.toString()}>{index}</Text>;
        })}
      </ScrollView>
    </View>
  );
    ...
    <NavigationContainer>
      <Stack.Navigator>
        <Stack.Screen
          name="Home"
          component={Home}
          initialParams={{ backgroundColor: 'lightsalmon', forward: true }}
        />
        <Stack.Screen
          name="SecondHome"
          component={Home}
          initialParams={{ backgroundColor: 'goldenrod', forward: true }}
        />
        <Stack.Screen
          name="ThirdHome"
          component={Home}
          initialParams={{ backgroundColor: 'lightblue', forward: false }}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
