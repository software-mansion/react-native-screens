...
export const NativeStackNavigatorComponent = ({
  ...
  <NavigationContainer>
    <Stack.Navigator>
      <Stack.Screen
        options={customScreenOneNavigationOptions}
        name={customScreenOneName || 'ScreenOne'}
        component={CustomScreenOne ? CustomScreenOne : ScreenOne}
      />
      <Stack.Screen
        options={customScreenTwoNavigationOptions}
        name={customScreenTwoName || 'ScreenTwo'}
        component={CustomScreenTwo ? CustomScreenTwo : ScreenTwo}
      />
      <Stack.Screen
        options={customScreenThreeNavigationOptions}
        name={customScreenThreeName || 'ScreenThree'}
        component={CustomScreenThree ? CustomScreenThree : ScreenThree}
      />
    </Stack.Navigator>
  </NavigationContainer>
);
