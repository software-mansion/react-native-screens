...
const DetailsScreen = () => {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      ...
      headerRight: () => {
        ...
        return <HeaderButton ><Text>X</Text></HeaderButton> ;
      }
    });
  }, [navigation, text]);
  const onHandlePress = () => {
  ...
  return (
    <View>
      ...
      <View>
      <TextInput  style={{ backgroundColor: 'grey', height: 40, borderColor: 'black' }} placeholder='Enter text' value={text} onChangeText={(text) => {
          setText(text);
        }}/>
