...
Incomplete: Not automated. Which screen moves, in which direction, and
whether an intermediate screen flashes are visual qualities that Detox
cannot assert reliably. This scenario is manual only.
