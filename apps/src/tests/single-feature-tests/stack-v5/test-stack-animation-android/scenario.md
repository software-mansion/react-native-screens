...
Incomplete: Not automated. Animation smoothness, draw order, button shadows
continuity, absence of content jumps and the interactive predictive back
gesture are visual / interactive qualities that Detox cannot assert reliably.
