...
import TestStackNavigationItemStyleIOS from './test-stack-navigation-item-style-ios';
...
export { default as TestStackNavigationItemStyleIOS } from './test-stack-navigation-item-style-ios';
