...
2. Tap on Item 1
  - [ ] A toast "onPress Item 1" is displayed
...
5. Click "Toggle items count (2/5)" three times to reach 5 items
  - [ ] Item 0 and Item 1 are no longer visible in the header — they have been moved to the overflow menu
...
7. Tap on Item 0 in the overflow menu
  - [ ] A toast "onPress Item 0" is displayed
8. Tap on Item 1 in the overflow menu
  - [ ] A toast "onPress Item 1" is displayed
