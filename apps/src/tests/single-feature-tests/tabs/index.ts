...
import TestTabsProminentTabScreenKey from './test-tabs-prominent-tab-screen-key-ios';
...
export { default as TestTabsProminentTabScreenKey } from './test-tabs-prominent-tab-screen-key-ios';
