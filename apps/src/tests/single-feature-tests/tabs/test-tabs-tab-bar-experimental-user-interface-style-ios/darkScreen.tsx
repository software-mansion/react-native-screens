...
export function DarkRootScreen({ onPush }: { onPush: () => void }) {
  return (
    <View style={{ flex: 1}}>
      <ScrollView style={{ padding: 40,backgroundColor: 'black' }}>
        <View>
...
export function DarkInterfaceStyleScreen() {
  return (
    <TabsContainerWithHostConfigContext routeConfigs={ROUTE_CONFIGS} nativeContainerStyle={{ backgroundColor: 'black' }}/>
  );
}
