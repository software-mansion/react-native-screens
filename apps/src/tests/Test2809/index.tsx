...
// DefaultText/CustomText/StyledText/CustomStyledText - based on label content
...
const EnabledDefaultCustomStyledText = createStackWithOptions(
  {},
  { headerBackTitle: 'Custom', headerBackTitleStyle: { fontSize: 30 } },
);
...
const EnabledGenericCustomStyledText = createStackWithOptions(
  {},
  {
    headerBackButtonDisplayMode: 'generic',
    headerBackTitle: 'Custom',
...
const EnabledMinimalCustomStyledText = createStackWithOptions(
  {},
  {
    headerBackButtonDisplayMode: 'minimal',
    headerBackTitle: 'Custom',
...
const DisabledDefaultCustomStyledText = createStackWithOptions(
  {},
  {
    headerBackButtonMenuEnabled: false,
    headerBackTitle: 'Custom',
...
const DisabledGenericCustomStyledText = createStackWithOptions(
  {},
  {
    headerBackButtonMenuEnabled: false,
    headerBackTitle: 'Custom',
...
const DisabledMinimalCustomStyledText = createStackWithOptions(
  {},
  {
    headerBackButtonMenuEnabled: false,
    headerBackTitle: 'Custom',
...
function Home({
  ...
  return (
    <View
      ...
      />
      <Button
        title="EnabledDefaultCustomStyledText"
        onPress={() => navigation.navigate('EnabledDefaultCustomStyledText')}
      />
      ...
      />
      <Button
        title="EnabledGenericCustomStyledText"
        onPress={() => navigation.navigate('EnabledGenericCustomStyledText')}
      />
      ...
      />
      <Button
        title="EnabledMinimalCustomStyledText"
        onPress={() => navigation.navigate('EnabledMinimalCustomStyledText')}
      />
      ...
      />
      <Button
        title="DisabledDefaultCustomStyledText"
        onPress={() => navigation.navigate('DisabledDefaultCustomStyledText')}
      />
      ...
      />
      <Button
        title="DisabledGenericCustomStyledText"
        onPress={() => navigation.navigate('DisabledGenericCustomStyledText')}
      />
      ...
      />
      <Button
        title="DisabledMinimalCustomStyledText"
        onPress={() => navigation.navigate('DisabledMinimalCustomStyledText')}
      />
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        />
        <Stack.Screen
          name="EnabledDefaultCustomStyledText"
          component={EnabledDefaultCustomStyledText}
        />
        ...
        />
        <Stack.Screen
          name="EnabledGenericCustomStyledText"
          component={EnabledGenericCustomStyledText}
        />
        ...
        />
        <Stack.Screen
          name="EnabledMinimalCustomStyledText"
          component={EnabledMinimalCustomStyledText}
        />
        ...
        />
        <Stack.Screen
          name="DisabledDefaultCustomStyledText"
          component={DisabledDefaultCustomStyledText}
        />
        ...
        />
        <Stack.Screen
          name="DisabledGenericCustomStyledText"
          component={DisabledGenericCustomStyledText}
        />
        ...
        />
        <Stack.Screen
          name="DisabledMinimalCustomStyledText"
          component={DisabledMinimalCustomStyledText}
        />
