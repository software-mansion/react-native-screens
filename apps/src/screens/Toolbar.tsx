          ...
          unstable_toolbarItems: () => [
            {
              ...
              onPress: () => Alert.alert('Bold Red pressed'),
            },
            { type: 'flexibleSpace' },
            {
              type: 'button',
              label: 'Georgia',
              labelStyle: { fontFamily: 'Georgia', fontSize: 18, fontStyle: 'italic' },
              onPress: () => Alert.alert('Georgia pressed'),
            },
            { type: 'flexibleSpace' },
            {
              type: 'button',
              label: 'Small Teal',
              labelStyle: { fontSize: 11, color: 'teal' },
              onPress: () => Alert.alert('Small Teal pressed'),
            },
          ],
        }}
      />
