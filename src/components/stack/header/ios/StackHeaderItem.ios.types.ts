 ...
 *
 * @description
 * Mirrors `UIBarButtonItemVisibilityPriority`, which is an extensible enum over
 * `NSInteger`: besides the three named values any number can be used to place
 * an item between or beyond them.
 *
 * @platform iOS
 *
