...
export interface SplitViewHostProps extends ViewProps {
   ...
   * @platform ios
   */
  onCollapse?: (e: NativeSyntheticEvent<TargetedEvent>) => void;
  /**
   * A callback that gets invoked when the SplitView was expanded to multiple columns.
   *
   * @platform ios
   */
  onExpand?: (e: NativeSyntheticEvent<TargetedEvent>) => void;
  /**
...
export interface SplitViewScreenProps extends ViewProps {
   ...
   * @platform ios
   */
  onDidAppear?: (e: NativeSyntheticEvent<TargetedEvent>) => void;
  /**
   ...
   * @platform ios
   */
  onDidDisappear?: (e: NativeSyntheticEvent<TargetedEvent>) => void;
  /**
