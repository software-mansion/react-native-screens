...
namespace winrt::RNScreens::implementation {
    ...
    void ScreenStackViewManager::AddView(FrameworkElement parent, UIElement child, int64_t index) {
    ...
    void ScreenStackViewManager::RemoveChildAt(FrameworkElement parent, int64_t index) {
        auto screenStack = parent.as<ScreenStack>();
        if (!screenStack)
            return;
    ...
    void ScreenStackViewManager::ReplaceChild(FrameworkElement parent, UIElement oldChild, UIElement newChild) {
        auto screenStack = parent.as<ScreenStack>();
        if (!screenStack)
            return;
    ...
    IMapView<hstring, ViewManagerPropertyType> ScreenStackViewManager::NativeProps() noexcept {
    ...
    ConstantProviderDelegate ScreenStackViewManager::ExportedCustomBubblingEventTypeConstants() noexcept {
        return nullptr;
    }

    ConstantProviderDelegate ScreenStackViewManager::ExportedCustomDirectEventTypeConstants() noexcept {
        return nullptr;
    }
