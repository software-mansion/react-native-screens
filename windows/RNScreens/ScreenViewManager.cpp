...
namespace winrt::RNScreens::implementation {
    ...
    void ScreenViewManager::AddView(FrameworkElement parent, UIElement child, int64_t index) {
        (void)index;
    ...
    void ScreenViewManager::ReplaceChild(FrameworkElement parent, UIElement oldChild, UIElement newChild) {
        auto screen = parent.try_as<Screen>();
        if (!screen)
            return;
    ...
    IMapView<hstring, ViewManagerPropertyType> ScreenViewManager::NativeProps() noexcept {
    ...
    ConstantProviderDelegate ScreenViewManager::ExportedCustomBubblingEventTypeConstants() noexcept {
        return nullptr;
    }

    ConstantProviderDelegate ScreenViewManager::ExportedCustomDirectEventTypeConstants() noexcept {
