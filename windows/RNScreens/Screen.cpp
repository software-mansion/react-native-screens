...
namespace winrt::RNScreens::implementation {
    ...
    void Screen::replaceChild(winrt::Windows::UI::Xaml::UIElement oldChild,
    ...
    void Screen::onLoading(winrt::Windows::UI::Xaml::FrameworkElement const& sender,
    ...
    void Screen::onLoaded(winrt::Windows::Foundation::IInspectable const& sender,
    ...
    void Screen::onUnloaded(winrt::Windows::Foundation::IInspectable const& sender,
        winrt::Windows::UI::Xaml::RoutedEventArgs const&) {
        auto screen = sender.try_as<Screen>();
        if (!screen)
            return;
