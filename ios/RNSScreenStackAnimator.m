...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
  ...
  if (screen != nil) {
    ...
    } else if (screen.stackAnimation == RNSScreenStackAnimationUpDown) {
      [self animateTopDownWithTransitionContext:transitionContext toVC:toViewController fromVC:fromViewController];
    }
  }
}
...
- (void)animateTopDownWithTransitionContext:(id<UIViewControllerContextTransitioning>)transitionContext
                                    toVC:(UIViewController *)toViewController fromVC:(UIViewController *)fromViewController
{
