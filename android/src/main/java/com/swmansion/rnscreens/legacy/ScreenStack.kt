...
import com.swmansion.rnscreens.legacy.events.StackFinishTransitioningEvent
import com.swmansion.rnscreens.legacy.stack.views.ChildrenDrawingOrderStrategy
import com.swmansion.rnscreens.legacy.stack.views.ReverseFromIndex
import com.swmansion.rnscreens.legacy.stack.views.ReverseOrder
import com.swmansion.rnscreens.legacy.stack.views.ScreensCoordinatorLayout
import com.swmansion.rnscreens.legacy.utils.setTweenAnimations
...
class ScreenStack(
    ...
    override fun onUpdate() {
        ...
        var stackAnimation: Screen.StackAnimation? = null
    ...
    companion object {
        ...
        private fun needsDrawReordering(
            ...
            resolvedStackAnimation: Screen.StackAnimation?,
        ): Boolean {
