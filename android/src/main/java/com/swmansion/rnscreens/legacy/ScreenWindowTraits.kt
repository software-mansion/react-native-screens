...
object ScreenWindowTraits {
    ...
    internal fun setOrientation(
        ...
        val screenForOrientation = findScreenForTrait(screen, Screen.WindowTraits.ORIENTATION)
    ...
    internal fun setStyle(
        ...
        val screenForStyle = findScreenForTrait(screen, Screen.WindowTraits.STYLE)
    ...
    internal fun setHidden(
        ...
        val screenForHidden = findScreenForTrait(screen, Screen.WindowTraits.HIDDEN)
    ...
    internal fun setNavigationBarHidden(
        ...
        val screenForNavBarHidden = findScreenForTrait(screen, Screen.WindowTraits.NAVIGATION_BAR_HIDDEN)
    ...
    private fun checkTraitForScreen(
        ...
        when (trait) {
            Screen.WindowTraits.ORIENTATION -> screen.screenOrientation != null
            Screen.WindowTraits.STYLE -> screen.statusBarStyle != null
            Screen.WindowTraits.HIDDEN -> screen.isStatusBarHidden != null
            Screen.WindowTraits.ANIMATED -> screen.isStatusBarAnimated != null
            Screen.WindowTraits.NAVIGATION_BAR_HIDDEN -> screen.isNavigationBarHidden != null
        }
}
