...
import com.swmansion.rnscreens.legacy.utils.InsetsCompat
import com.swmansion.rnscreens.legacy.utils.getDecorViewTopInset
import com.swmansion.rnscreens.legacy.utils.resolveInsetsOrZero
...
open class CustomToolbar(
    ...
    private fun forceMeasureAndLayoutPass() {
