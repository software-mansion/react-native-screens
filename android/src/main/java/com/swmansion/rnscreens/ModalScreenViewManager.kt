...
import com.facebook.react.viewmanagers.RNSModalScreenManagerDelegate
...
class ModalScreenViewManager : ViewGroupManager<Screen>(), RNSModalScreenManagerInterface<Screen> {
    private val delegate: ViewManagerDelegate<Screen>

    init {
        delegate = RNSModalScreenManagerDelegate<Screen, ModalScreenViewManager>(this)
    }
