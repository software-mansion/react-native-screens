...
class YGLSN : public LayoutableShadowNode {
 public:
  using Shared = std::shared_ptr<const YGLSN>;
...
#pragma mark - Constructors
  ...
  YGLSN(const ShadowNode &sourceShadowNode, const ShadowNodeFragment &fragment);
...
#pragma mark - LayoutableShadowNode
 ...
 private:
   ...
   * returns false.
   */
  bool doesOwn(const YGLSN &child) const;
   ...
   * adjustment).
   */
  void appendYogaChild(const YGLSN::Shared &childNode);
   ...
   */
  YGLSN &cloneChildInPlace(size_t layoutableChildIndex);
  ...
  static float yogaNodeBaselineCallbackConnector(
      ...
      float width,
      float height);
  static YGLSN &shadowNodeFromContext(YGNodeConstRef yogaNode);
