...
// https://github.com/AppAndFlow/react-native-safe-area-context/blob/v5.6.1/common/cpp/react/renderer/components/safeareacontext/RNCSafeAreaViewComponentDescriptor.h
