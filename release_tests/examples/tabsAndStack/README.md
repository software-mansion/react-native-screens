...
```bash
node scripts/release_tests/create_playground.js -s current -e tabsAndStack
# or
node scripts/release_tests/create_playground.js -s tag:5.0.0-alpha.1 -r 0.84.0 -e tabsAndStack
```
